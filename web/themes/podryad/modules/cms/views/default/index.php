...
<main class="main">
    <div class="main-content">
        ...
        <div class="seo-text">
            ...
            <p>Для тех пользователей, которые хотят сэкономить время, а возможно и деньги, на сайте есть функция «Объявить  тендер». Опишите объем работ, укажите Ваш бюджет или пусть он будет договорным – заинтересованные подрядчики оставят Вам свои ценовые предложения.
            </p>
