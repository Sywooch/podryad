...
<main class="main">
    <div class="main-content">
        ...
        <div class="seo-text">
            ...
            <p>Хотите сделать ремонт квартиры или построить дом? Ищите, у кого заказать дизайн интерьера? Вам нужна услуга «муж на час» или ремонт стиральных машин на дому в Вашем городе? С этим и многим другим Вам поможет Podryad.kz. Podryad.kz – это сервис помогающий быстро найти подрядчика для выполнение любых ремонтных и строительных работ.
            </p>
            <p>Podryad.kz сделает Ваш поиск подрядчика простым и удобным. Для Вашего внимания на нашем сайте зарегистрированы ремонтные и строительные подрядчики со всех городов Казахстана, готовые выполнить Ваш заказ. Портфолио с фотографиями выполненных строительных/ремонтных работ и реальные отзывы людей помогут Вам сделать правильный выбор.
            </p>
            ...
            <p>Для тех пользователей, которые хотят сэкономить время, а возможно и деньги, на сайте есть функции «Объявить  тендер». Опишите объем работ, укажите Ваш бюджет или пусть он будет договорным – заинтересованные подрядчики оставят Вам свои ценовые предложения.
            </p>
